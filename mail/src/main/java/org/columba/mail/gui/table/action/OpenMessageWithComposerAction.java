 ...
 */
public class OpenMessageWithComposerAction extends AbstractColumbaAction
    implements ISelectionListener {
    public OpenMessageWithComposerAction(IFrameMediator frameMediator) {
        super(frameMediator,
...
//        putValue(LARGE_ICON, MailImageLoader.getIcon("email_edit.png"));
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        CommandProcessor.getInstance().addOp(new OpenMessageWithComposerCommand(r));
    }
