 ...
 * <p>
 * The <code> StatusBar</code> listens for {@link TaskManagerEvent} to provide visual feedback. This includes a status message text and the progress bar.
 * <p>
 * In a model/view/controller pattern, the statusbar is the view, the taskmanager the underlying model.
 * 
 * @author fdietz
 */
public class TaskManager
{
  ...
  /**
   * We need a mutex to be sure that modifying the workerList is thread-safe at all time
   */
