 ...
 * <p>
 * Note that {@link Command}objects get {@link Worker}objects only when executed.
 * 
 * @author fdietz
 */
public class Worker extends SwingWorker implements IWorkerStatusController
{
  ...
  /**
   * Constant definining the delay used when using clearDisplayTextWithDelay(). Defined to be 500 millisec.
   */
   ...
   * <p>
   * All general exceptions are caught here, nice error dialogs shown to the users.
   * 
  ...
  protected void fireWorkerStatusChanged(WorkerStatusChangedEvent e)
  {
    ...
    {
      ((IWorkerStatusChangeListener) workerStatusChangeListeners.get(i)).workerStatusChanged(e);
    }
  }
