...
public class TableView extends JPanel implements ListSelectionListener {
    ...
    */
        ...
        try {
            ...
            if (tc != null) {
                ...
                if (column.getValueString() != null) {
                    tc.setHeaderRenderer(new AddressbookCommonHeaderRenderer(
                            column.getValueString(), sorter));
                } else {
                    tc.setHeaderRenderer(new AddressbookCommonHeaderRenderer(
                            column.getName(), sorter));
                }
    ...
    public void setupRenderer() {
        TableItem headerItemList = new TableItem(AddressbookConfig.get(
                    "options").getElement("/options/gui/table"));
