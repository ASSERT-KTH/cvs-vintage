...
public class StatusBarExtensionHandler extends ExtensionHandler {
	public static final String XML_RESOURCE = "/org/columba/core/plugin/statusbar.xml";

	public static final String NAME = "org.columba.core.statusbar";

	public StatusBarExtensionHandler() {
		super(NAME);
