...
public class LogProperty {
    public static String createPropertyString(File configDir) {
        ...
        buf.append("log4j.appender.destall.File=" + dir + pathDelimiter +
            "columba-all.log\n");
        ...
        buf.append("log4j.appender.desterr.File=" + dir + pathDelimiter +
            "columba-error.log\n");
        ...
        buf.append("log4j.appender.destinfo.File=" + dir + pathDelimiter +
            "columba-info.log\n");
        ...
        buf.append("log4j.appender.destdebug.File=" + dir + pathDelimiter +
            "columba-debug.log\n");
