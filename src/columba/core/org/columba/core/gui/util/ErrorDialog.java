...
public class ErrorDialog extends JDialog implements ActionListener {
    ...
    private JPanel createCenterPanel(boolean showDetails) {
        FormLayout layout = new FormLayout("default, 3dlu, left:default",
        ...
        if (showDetails) {
            centerPanel.add(new JScrollPane(stacktraceTextArea), cc.xywh(1, 5, 3, 1));
        }
    ...
    private void initComponents() {
        ...
        messageMultiLineLabel.setFont(
            messageMultiLineLabel.getFont().deriveFont(Font.BOLD));
