...
import org.columba.core.scripting.BeanshellService;
    ...
    implements IColumbaService
{
  ...
  private static final Logger 
    LOG = Logger.getLogger(FileMonitorService.class.getName());
  ...
  public FileMonitorService()
  {
    ...
    observerThread = new ObserverThread(ObserverThread.DEFAULT_POLLING_INTERVAL);
  }
    ...
    throws FileNotFoundException,FileMonitorException
  {
    ...
    if (file.isDirectory())
      throw new FileMonitorException("Monitoring directories not yet supported");
