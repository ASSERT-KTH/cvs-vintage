...
public class JEREMIEContext implements Context {
     ...
     * JNDIResourceWrapper Object here the good way is to contact the carol
     * configuration to get the jeremie protable remote object
     * @param o the object to encode
     * @return a <code>Remote JNDIRemoteReference Object</code> if o is a
     *         ressource o if else
     */
    private Object wrapObject(Object o, Object name, boolean replace) throws NamingException {
        try {
