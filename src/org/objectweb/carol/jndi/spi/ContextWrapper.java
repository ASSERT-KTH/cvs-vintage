/*
 * @(#) ContextWrapper.java	1.0 27/01/2004
 *
 * Copyright (C) 2004 - INRIA (www.inria.fr)
 *
...
public class ContextWrapper implements Context {
     ...
     * and instanciate initial contexts
     */
    ...
    public void bind(String name, Object obj) throws NamingException {
        if (TraceCarol.isDebugJndiCarol()) {
            TraceCarol.debugJndiCarol("ContextWrapper.bind("+name+","+simpleClass(obj.getClass().getName())+" object)");
        }
        try {
            ...
            if (TraceCarol.isDebugJndiCarol()) {
                String msg = "ContextWrapper.bind("+name+","+simpleClass(obj.getClass().getName())+" object) failed: " + e; 
                TraceCarol.debugJndiCarol("Error: " + msg + " " + e);
            }
            throw e;
        }
    ...
    public void rebind(String name, Object obj) throws NamingException {
        if (TraceCarol.isDebugJndiCarol()) {
            TraceCarol.debugJndiCarol("ContextWrapper.rebind("+name+","+simpleClass(obj.getClass().getName())+" object)");
        }
        try {	    
    ...
    public Object addToEnvironment(String propName, Object propVal) 
        ...
        try {
            if (TraceCarol.isDebugJndiCarol()) {
                TraceCarol.debugJndiCarol("ContextWrapper.addToEnvironment("+propName+","+simpleClass(propVal.getClass().getName())+" object)");
            }
