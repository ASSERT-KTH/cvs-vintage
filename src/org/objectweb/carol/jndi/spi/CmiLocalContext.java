 ...
 *
 * --------------------------------------------------------------------------
 * $Id: CmiLocalContext.java,v 1.1 2006/01/26 16:28:55 pelletib Exp $
 * --------------------------------------------------------------------------
 */
...
import org.objectweb.carol.jndi.registry.CmiRegistryWrapperContext;
 ...
 */
public class CmiLocalContext extends CmiContext implements Context {

    /**
     * Constructs an CMI local Wrapper context
     * @param cmiLocalContext the inital Local JRMP context
     * @throws NamingException if the registry wrapper cannot be build
     */
    public CmiLocalContext(Context cmiLocalContext) throws NamingException {
        super(new CmiRegistryWrapperContext(cmiLocalContext.getEnvironment()));
    }
