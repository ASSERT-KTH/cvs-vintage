...
public class ManageableRegistry extends RegistryImpl {
	...
	public void purge() {
		RegistryManager reg =
			(RegistryManager) remoteObjectTable.get(REGISTRY_MANAGER_NAME);
		...
		try {
			...
			if (!(writeFirewall.isAllow(clientHost))) {
				throw new AccessException(
					"Write in registry disallowed; from "
						+ clientHost
						+ " host");
			}
