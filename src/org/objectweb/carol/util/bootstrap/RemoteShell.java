...
public class RemoteShell {
     ...
     *        this daemon (Optional, default 9090)
     */
    public static void main(String args[]) {
        ...
        try {
            ...
            while ((!line.equalsIgnoreCase("stop")) && (!line.equalsIgnoreCase("quit"))
    ...
    private static void printConf(String line) throws Exception {
        try {
            ...
            if (st.countTokens() < 2) {
                ...
                System.out.println("The process " + procName + " is launch in directory: "
                        + procServer.getProcessDirectory(procName));
                System.out.println("The process " + procName + " is launch with the command: "
                        + procServer.getProcessCommand(procName));
            }
        } catch (Exception e) {
            System.err.println(e);
        }
     ...
     * @throws Exception if the local file doen't existe or if a Remote
     *         exception occurs
     */
    ...
    public static void printHelpProcess() {
        ...
        System.out
                .println("exitv  <process name>                -> exit value of the process (-1) if the process is alive");
        ...
        System.out
                .println("dirjava  <dir>        <cmd>          -> launch a java command in dir (create if necessary)");
