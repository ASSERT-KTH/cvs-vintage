...
rem $Id: boot.bat,v 1.1 2002/02/21 23:33:19 chirino Exp $
...
set JAVAC_JAR=file:%JAVA_HOME%/lib/tools.jar
set JBOSS_CLASSPATH=%JBOSS_CLASSPATH%,%JAVAC_JAR%,file:run.jar
...
java %JAVA_OPTS% %JAXP% -classpath boot.jar org.jboss.Boot -cp "%JBOSS_CLASSPATH%" org.jboss.Main %1 %2 %3 %4 %5 %6 %7 %8 %9
