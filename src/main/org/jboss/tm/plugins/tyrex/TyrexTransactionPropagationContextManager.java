...
// ------------ TransactionPropagationContextFactory methods ------------
  ...
  public Object getTransactionPropagationContext() {
    ...
    try {
      ...
      // DEBUG
      Logger.warning ("TyrexTransactionPropagationContextManager: unable to create propagation ctx!");
      e.printStackTrace();
    } finally {
      return tpc;
    }
...
// ------------- TransactionPropagationContextImporter methods -----------
  ...
  public Transaction importTransactionPropagationContext(Object tpc) {
    if (tpc instanceof TyrexTxPropagationContext) {
      Transaction oldTx;
      try {
        // DEBUG        Logger.debug ("TyrexTransactionPropagationContextManager: importing tpc.");
        ...
        // DEBUG        Logger.debug ("TyrexTransactionPropagationContextManager: transaction imported.");
        return newTx;
      } catch (Exception e) {
        e.printStackTrace();
        return null;
      ...
      Logger.warning("TyrexTransactionPropagationContextManager: unknown Tx PropagationContex");
      return null;
    }
  }
}