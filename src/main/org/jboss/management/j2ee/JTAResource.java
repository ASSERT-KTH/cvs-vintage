...
//AS         lLog.error( "Could not create JSR-77 JTAResource: " + pName, e );
         return null;
      }
      try {
         // Now create the JTAResource Representant
         return pServer.createMBean(
            "org.jboss.management.j2ee.JTAResource",
            null,
            new Object[] {
               pName,
               lServer,
   ...
   public static void destroy( MBeanServer pServer, String pName ) {
      ...
      try {
         ...
         ObjectName lSearch = new ObjectName(
            J2EEManagedObject.getDomainName() + ":j2eeType=JTAResource,name=" + pName + ",*"
         );
...
//AS         lLog.error( "Could not destroy JSR-77 JTAResource: " + pName, e );
      }
   }
   ...
   /**
    * @param pName Name of the JTAResource
    *
    * @throws InvalidParameterException If list of nodes or ports was null or empty
    **/
   public JTAResource( String pName, ObjectName pServer, ObjectName pService )
      throws
         MalformedObjectNameException,
         InvalidParentException
   {
      super( "JTAResource", pName, pServer );
      Logger log = getLog();
