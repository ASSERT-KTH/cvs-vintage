...
implements Externalizable, InvocationHandler
{
   ...
   // A proxy is associated with a given container, we identify the container by any object
   // in RH 3.0 this is for example a simple MBean identifying the container in the future 
   // we should give just an abstract key into a metadata container repository in the server
   ...
   * Invoke a method.
   *
   * The actual optimization happens in the delegate, the responsibility here it set the 
