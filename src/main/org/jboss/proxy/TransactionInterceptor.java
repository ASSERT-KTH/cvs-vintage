      ...
      throws Throwable
   {
      ...
      if (tm != null)
      {
         ...
         if (m != null)
         {
            ...
            //log.info("Looking for method " + m.getName() + " from declaring class: " + m.getDeclaringClass().getName() + " at hash : " + hash + " for container at hash " + ic.getObjectName());
            txSupport = (TxSupport)methodHashToTxSupportMap.get(new Long(hash));
