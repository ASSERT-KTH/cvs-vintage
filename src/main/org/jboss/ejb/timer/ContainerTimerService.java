...
{
   private static Logger log = Logger.getLogger(ContainerTimerService.class);
    ...
    */
   public ContainerTimerService(AbstractTimerSource pSource, String pName,
      Container pContainer, Object pKey)
   {
   ...
   {
      log.debug("cancel(), cancel timer: " + pId);
   ...
   public void handleTimedEvent(Integer pId, Date pNextEvent)
   {
      ...
      if (lTimer != null)
      {
         ...
         {
            log.trace("handleTimedEvent(), this: " + this
               + ", call timer: " + lTimer
   ...
   private void handleEjbTimeout(Container container, Timer pTimer)
   {
      ...
      try
      {
         ...
         if (transactionManager.getTransaction() != null)
         {
            ...
            log.warn("TRANSACTION IS STILL ALIVE!!!!!" + tx.getStatus());
         }
      }
      catch (Exception e)
      {
      ...
      EJBException
   {
      ...
      if (lKey != null && mKey == null)
      {
         ...
         ContainerTimerService lTimerService = (ContainerTimerService) mContainer.getTimerService(lKey);
         if( trace )
         {
            log.trace("restoreTimer(), AFTER CTS is created, container: " + mContainerName
               + ", id: " + pId + ", key: " + lKey
      ...
      else
      {
         if( trace )
         {
            log.trace("restoreTimer(), container: " + mContainerName + ", id: " + pId
