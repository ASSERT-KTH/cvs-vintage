...
extends AbstractInterceptor
{
    ...
    */
    public Object invoke(MethodInvocation mi) throws Exception {
		...
		// DEBUG Logger.log("TxInterceptorBMT disassociate" + ((t1==null) ? "null": Integer.toString(t1.hashCode())));
		Logger.log("TxInterceptorBMT disassociate" + ((t1==null) ? "null": Integer.toString(t1.hashCode())));
		
        // t2 refers to the instance transaction (spec ejb1.1, 11.6.1, p174) 
        Transaction t2 = mi.getEnterpriseContext().getTransaction();
        
		// DEBUG Logger.log("TxInterceptorBMT t2 in context" + ((t2==null) ? "null": Integer.toString(t2.hashCode())));
		Logger.log("TxInterceptorBMT t2 in context" + ((t2==null) ? "null": Integer.toString(t2.hashCode())));
        ...
        try {
			...
			if (t1 != null) {
				...
				// DEBUG Logger.log("TxInterceptorBMT reassociating client tx " + t1.hashCode());
				Logger.log("TxInterceptorBMT reassociating client tx " + t1.hashCode());
			...
			if (((SessionMetaData)container.getBeanMetaData()).isStateless()) {
			    ...
			    if (t3 != null) switch (t3.getStatus()) {
					...
					case Status.STATUS_PREPARED: 
						...
						// cf ejb1.1 11.6.1
						Logger.log("Application error: CMT stateless bean " + container.getBeanMetaData().getEjbName() + " should complete transactions before returning (ejb1.1 spec, 11.6.1)");
