...
public final class JDBCCMPFieldMetaData {
   ...
   public JDBCCMPFieldMetaData(
      ...
      // note: db-generated and key-generator-factory are mutually exclusive
      // should it be reflected here?
      isKeyDbGenerated =
         MetaData.getOptionalChild(element, "db-generated") != null;
   }
   ...
   public JDBCCMPFieldMetaData(
      ...
      // is key db-generated
      this.isKeyDbGenerated = defaultValues.isKeyDbGenerated();
   }
   ...
   /**
    * @return true if the key is generated by the database
    */
