...
public class ReadAheadCache 
{
         ...
         JDBCReadAheadMetaData readahead) 
   {
      ...
      {
         log.trace("Finder results not added:" +
               " entity=" + manager.getEntityBridge().getEntityName() +
               " result-size=" + results.size() +
               " listCacheMax=" + listCacheMax);
      ...
      // primary key. This is how read-ahead on-load works.
      //
      ...
      //
      // FIXME: I think this is really expensive... there has to be a better
      // way... possibly with weak references...
      //
