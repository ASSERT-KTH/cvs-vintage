...
public class SQLUtil
{
   ...
   private static Vector rwords = new Vector();
    ...
    */
   public static String getColumnNamesClause(JDBCFieldBridge field, String identifier)
   {
   ...
   public static String getSetClause(JDBCType type)
   {
      ...
      for(int i = 0; i < columnNames.length; i++)
      {
         ...
         buf.append(columnNames[i]).append(EQ_QUESTMARK);
      }
      return buf.toString();
   }
    ...
    *    [AND identifier.columnName2=? [...]]]
    */
   public static String getWhereClause(JDBCFieldBridge field, String identifier)
   {
   ...
   public static String getWhereClause(JDBCType type, String identifier)
   {
      ...
      for(int i = 0; i < columnNames.length; i++)
      {
         ...
         buf.append(identifier).append(columnNames[i]).append(EQ_QUESTMARK);
      }
      return buf.toString();
   }
    ...
    */
   public static String getIsNullClause(boolean not, List fields, String identifier)
   {
    ...
    *    [AND identifier.columnName2 IS [NOT] NULL [...]]]
    */
   public static String getIsNullClause(boolean not, JDBCFieldBridge field, String identifier)
   {
    ...
    *    [AND identifier.columnName2 IS [NOT] NULL [...]]]
    */
   public static String getIsNullClause(boolean not, JDBCType type, String identifier)
   {
      if(identifier.length() > 0)
      {
         identifier += '.';
   ...
   public static String getJoinClause(JDBCCMRFieldBridge cmrField, String parentAlias, String childAlias)
   {
      ...
      if(cmrField.hasForeignKey())
      {
         ...
         for(Iterator iter = parentFkFields.iterator(); iter.hasNext();)
         {
            ...
            buf.append(getJoinClause(parentField, parentAlias, childField, childAlias));
            if(iter.hasNext())
            {
               buf.append(AND);
            }
      ...
      else
      {
         ...
         List childFkFields = cmrField.getRelatedCMRField().getForeignKeyFields();
         for(Iterator iter = childFkFields.iterator(); iter.hasNext();)
         {
            ...
            // add the sql
            buf.append(SQLUtil.getJoinClause(parentField, parentAlias, childField, childAlias));
            if(iter.hasNext())
            {
               buf.append(AND);
            }
      ...
      String relationTableAlias)
   {
      ...
      for(Iterator iter = parentFields.iterator(); iter.hasNext();)
      {
         ...
         buf.append(SQLUtil.getJoinClause(parentField, parentAlias, relationField, relationTableAlias));
         if(iter.hasNext())
         {
            buf.append(AND);
         }
   ...
   {
      return getJoinClause(pkField.getJDBCType(), parent, fkField.getJDBCType(), child);
   }

   public static String getJoinClause(List pkFields, String parent, List fkFields, String child)
   {
    ...
    *    [AND parent.pkColumnName2=child.fkColumnName2 [...]]]
    */
   public static String getJoinClause(JDBCType pkType, String parent, JDBCType fkType, String child)
   {
      if(parent.length() > 0)
      {
         parent += '.';
      ...
      List fields, String fromIdentifier, String toIdentifier)
   {
      ...
      {
         JDBCType type = (JDBCType)iter.next();
         buf.append(getSelfCompareWhereClause(type, fromIdentifier, toIdentifier));
         if(iter.hasNext())
         {
            buf.append(AND);
         }
   ...
   public static String getSelfCompareWhereClause(
      JDBCFieldBridge fromField,
      JDBCFieldBridge toField,
      String fromIdentifier,
      String toIdentifier)
   {
      return getSelfCompareWhereClause(
         fromField.getJDBCType(), toField.getJDBCType(), fromIdentifier, toIdentifier);
   }
