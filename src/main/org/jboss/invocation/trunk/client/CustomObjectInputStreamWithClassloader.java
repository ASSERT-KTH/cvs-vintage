 ...
 * </ul>
 * 
 * Originaly from the org.jboss.util.stream package but it did a return cl.loadClass(classdesc.getName());
 * to resolveClass() but I have seen that to have problems with Object[]s. This implemenation uses the
 * Classes.loadClass() method to resolve the class.
 *
...
public class CustomObjectInputStreamWithClassloader extends ObjectInputStream
{
   ...
   {
      return Classes.loadClass(classdesc.getName(), cl);
   }
   ...
   protected Class resolveProxyClass(String[] interfaces) throws IOException, ClassNotFoundException
   {
      ...
      {
         interfacesClass[i] = Classes.loadClass(interfaces[i], cl);
