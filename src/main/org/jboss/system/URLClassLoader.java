...
* The ServiceLibraries keeps track of the UCL and asks everyone for resources and classes
*
...
*/
	...
	*/
	...
	{
		if (name.endsWith("CHANGEME")) 
			{ System.out.println("UCL LOAD LOCALLY "+this.hashCode()+" in loadClass "+name);}
	...
	public URL getResource(String name) {
		...
		if (name.endsWith("CHANGEME"))
			System.out.println("UCL GETRESOURCE "+name+ " in UCL "+this.hashCode());
