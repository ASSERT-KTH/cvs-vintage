...
*  Service Libraries.
* 
*  The service libraries is a central repository of all classes loaded by the ClassLoaders
*   @see <related>
...
implements ServiceLibrariesMBean, MBeanRegistration
{
	...
	{
		if (libraries == null) libraries = new ServiceLibraries();
	...
	throws ClassNotFoundException
	{
		...
		synchronized(classLoaders) 
		{
			...
			if (foundClass != null) 
			{
				...
				if (set == null) { set = new HashSet(); clToClassSetMap.put(cl, set);}
				...
				while (allLoaders.hasNext()) 
				{
					...
					if (!cl.equals(scl))
					{
						...
						if (resource != null) 
						{
							...
							if (set == null) { set = new HashSet(); clToResourceSetMap.put(cl, set);}
