   ...
   extends MetaData
{
    ...
    * in the enterprise bean code. The name is a JNDI name relative to
    * the java:comp/env context and must be unique within an enterprise
    * bean.
    */
   ...
   {
      refName = getElementContent(
         getUniqueChild(element, "resource-env-ref-name"));
      type = getElementContent(
         getUniqueChild(element, "resource-env-ref-type"));
   }
