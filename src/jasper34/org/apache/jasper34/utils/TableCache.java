 ...
 * 	flushing on an object-by-object basis.  Stored objects that
 ...
 * 	@author Mel Martinez
*/
public class TableCache extends Hashtable implements Cache{

    /**
 * 		An <i>ArrayList</i> to track the usage of entries in this <i>SimpleCache</i>.
    */
    private Vector useage = new Vector(); //used to track most recent useage
 ...
 *     		when the maxSize is reached
    */
    public TableCache(int maxSize,int flushIncrement){
 ...
 *     			this is not the same as maxSize
    */
    public TableCache(int maxSize,int flushIncrement, int initialSize){
 ...
 *     			when rehashing should occur
    */
    public TableCache(int maxSize,int flushIncrement, int initialSize,float loadFactor){
