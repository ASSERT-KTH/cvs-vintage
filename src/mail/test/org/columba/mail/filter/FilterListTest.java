 ...
 */
    public void testAdd() {
        ...
        assertEquals("Wrong number of filters in the list.", 1,
            filterList.count());
        filterList.add(null);
        assertEquals("Wrong number of filters in the list.", 1,
            filterList.count());
        filterList.add(createNamedFilter("ONE"));
        assertEquals("Wrong number of filters in the list.", 2,
            filterList.count());
    }
 ...
 */
    public void testRemoveFilter() {
        ...
        assertEquals("Wrong number of filters in the list.", 3,
            filterList.count());
 ...
 */
    public void testCount() {
        ...
        assertEquals("Expected a filter list with one filter", 1,
            filterList.count());
        filterList.remove(0);
        assertEquals("Expected an empty filter list", 0, filterList.count());
    }
