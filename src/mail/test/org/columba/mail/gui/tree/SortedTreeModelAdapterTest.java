...
public class SortedTreeModelAdapterTest extends TestCase {
    ...
    public void testGetChild() {
        ...
        assertSame("Expected the same object at index 2 in the sorted list", orgModel.getChild(orgRootNode, 2), sortedModel.getChild(orgRootNode, 2));
    }
    ...
    public void testSort() {
        ...
        assertSame("Expected the same object at index 0 in the sorted list", orgModel.getChild(bChild, 2), sortedModel.getChild(bChild, 0));
        assertSame("Expected the same object at index 1 in the sorted list", orgModel.getChild(bChild, 1), sortedModel.getChild(bChild, 1));
        assertSame("Expected the same object at index 2 in the sorted list", orgModel.getChild(bChild, 3), sortedModel.getChild(bChild, 2));
        assertSame("Expected the same object at index 3 in the sorted list", orgModel.getChild(bChild, 0), sortedModel.getChild(bChild, 3));
    }
    ...
    public void testIsLeaf() {
        Object orgBChild = orgModel.getChild(orgRootNode, 0);
        assertEquals("The B child is not a child as it is in the original model.", orgModel.isLeaf(orgBChild), sortedModel.isLeaf(orgBChild));
    }
    ...
    public void testGetChildCount() {
        ...
        Object orgBChild = orgModel.getChild(orgRootNode, 0);
        assertEquals("The number of childs of the B child is not correct", orgModel.getChildCount(orgBChild), sortedModel.getChildCount(orgBChild));
    }
    ...
    public void testGetIndexOfChild() {
        assertEquals("The child should be the middle child in the sorted list.", 1, sortedModel.getIndexOfChild(orgRootNode, orgModel.getChild(orgRootNode, 0)));
        assertEquals("The child should be the first child in the sorted list.", 0, sortedModel.getIndexOfChild(orgRootNode, orgModel.getChild(orgRootNode, 1)));
        assertEquals("The child should be the last child in the sorted list.", 2, sortedModel.getIndexOfChild(orgRootNode, orgModel.getChild(orgRootNode, 2)));
    }
    ...
    public void testNodesInsertedEvent() {
        ...
        listener.clearEvents();
        MutableTreeNode orgBChild = (MutableTreeNode) orgModel.getChild(orgRootNode, 0);
        ...
        assertSame("The event did not occur with the B node as the parent", orgBChild, paths[1]);
        assertEquals("The number of new childs was not correct.", 1, newChildIndexes.length);
        assertEquals("The new node's index was not sorted in the model.", 1, newChildIndexes[0]);
        assertSame("The model has a different object for the event's index", newNode, sortedModel.getChild(orgBChild, newChildIndexes[0]));
    }
    ...
    public void atestNodesChangedEvent() {
        DummyTreeListener listener = new DummyTreeListener();
        sortedModel.addTreeModelListener(listener);
        DefaultMutableTreeNode orgBChild = (DefaultMutableTreeNode) orgModel.getChild(orgRootNode, 0);
        ...
        assertSame("The event did not occur with the root node as the parent", orgRootNode, paths[0]);
        assertSame("The changed object from the event is not the one that was changed.", orgBChild, listener.treeNodeChangedEvent.getChildren()[0]);
    }
    ...
    public void testTreeStructureChangedEvent() {
        ...
        assertNull("The children list should be null", listener.treeStructureChangedEvent.getChildren());
        assertSame("The event did not occur with the root node as the parent", orgRootNode, paths[0]);
        assertSame("The event did not occur with the root node as the parent", orgBChild, paths[1]);
    }
