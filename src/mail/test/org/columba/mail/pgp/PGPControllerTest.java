 ...
 */
    ...
    public void testVerifySig() throws Exception {
        String sigData = "-----BEGIN PGP SIGNATURE-----\n" +
            "Version: GnuPG v1.2.2-rc1-SuSE (GNU/Linux)\n\n" +
            "iD8DBQA/Dsyrrax/zviVYscRAkf2AJ9Y5h30EGkNplHCMCJg9wYOJk+t9wCdFBDO\n" +
            "UT8MCuHOLNANpmWGqGWFmkc=\n" + "=P9GA\n" +
            "-----END PGP SIGNATURE-----";
        InputStream sigDataStream = new ByteArrayInputStream(sigData.getBytes(
                    "ISO-8859-1"));
        String pgpMessage = "eine Testmessage";
        InputStream message = new ByteArrayInputStream(pgpMessage.getBytes(
                    "ISO-8859-1"));
...
*/
    ...
    public void testDecrypt() throws Exception {
        String testData = "-----BEGIN PGP MESSAGE-----\n" +
            "Version: GnuPG v1.2.2-rc1-SuSE (GNU/Linux)\n\n" +
