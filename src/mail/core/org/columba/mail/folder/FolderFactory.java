...
public class FolderFactory {
	 ...
	 * @throws Exception
	 */
	public FolderTreeNode createDefaultChild( FolderTreeNode parent, String name ) throws Exception {
	 ...
	 * @throws Exception
	 */
	public FolderTreeNode createChild( FolderTreeNode parent, String name, String childType ) throws Exception {
		
		FolderTreeNode child = (FolderTreeNode) handler.getPlugin(childType, new Object[] { name, childType } );
