...
public class CreateVFolderOnMessageCommand extends FolderCommand {
	...
	public void execute(Worker worker) throws Exception {
		...
		vfolder =
			createVirtualFolder(name, vfolderType, headerValue, parentFolder);
	...
	public VirtualFolder createVirtualFolder(
		...
		vfolder.getFolderItem().set("property", "source_uid", parentUid);
		vfolder.getFolderItem().set("property", "include_subfolders", false);
