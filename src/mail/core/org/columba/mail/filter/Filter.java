...
/**
 * Wrapper for the filter xml configuration, which makes code easier
 * to read in comparison to using the XmlElement stuff.
 * 
 * @author frd
 */
...
public class Filter extends DefaultItem {
	 ...
	 * 
	 * For efficiency reasons all commands are packaged in a compound command
	 * object. This compound command uses only one worker to execute all
	 * commands, instead of creating new workers for every command
	 * 
	 * @param srcFolder
	 *            source folder
	 * @param uids
	 ...
	 * @throws Exception
	 */
	public CompoundCommand getCommand(AbstractMessageFolder srcFolder, Object[] uids)
			throws Exception {
