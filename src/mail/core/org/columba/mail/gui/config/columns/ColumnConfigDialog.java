...
import org.columba.core.gui.checkablelist.CheckableItemImpl;
 ...
 * @author fdietz
 */
public class ColumnConfigDialog
	...
	public void valueChanged(ListSelectionEvent e) {
		...
		if (!theList.isSelectionEmpty()) {
			...
			selection=
				(CheckableItemImpl)
					((CheckableItemListTableModel) list.getModel()).getElement(
					index);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (action.equals("OK")) {
			...
			ColumnOptionsPlugin plugin=
				(ColumnOptionsPlugin) mediator
