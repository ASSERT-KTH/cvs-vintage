...
*/
    ...
    protected JPanel createButtonPanel() {
        ...
        ButtonWithMnemonic helpButton = new ButtonWithMnemonic(MailResourceLoader.getString(
                    "global", "help")); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void updateComponents(boolean b) {
        if (b) {
            ...
            for (int i = 0; i < property.count(); i++) {
                OptionsItem optionsItem = new OptionsItem((XmlElement) property.getElement(
                            i).clone());
...
*/
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        if (action.equals("CANCEL")) { //$NON-NLS-1$
            ...
            getMediator().getFolderOptionsController().createDefaultSettings(folder);
...
*/
            ...
            ((CheckableItemListTableModel) checkableList.getModel()).updateRow(item);
