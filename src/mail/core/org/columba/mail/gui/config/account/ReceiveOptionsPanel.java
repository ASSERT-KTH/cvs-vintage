 ...
 */
    ...
    protected void layoutComponents() {
        ...
        b.append(intervalCheckingLabel, intervalCheckingTextField);
 ...
 */
    ...
    public void updateComponents(boolean b) {
        ...
        if (b) {
            intervalCheckingCheckBox.setSelected(receiveItem.getBoolean(
                    "enable_mailcheck"));
            ...
            autodownloadCheckBox.setSelected(receiveItem.getBoolean(
                    "automatically_download_new_messages"));

            intervalCheckingTextField.setText(receiveItem.get(
                    "mailcheck_interval"));
            ...
            receiveItem.set("enable_mailcheck",
            ...
            receiveItem.set("mailcheck_interval",
                intervalCheckingTextField.getText());
