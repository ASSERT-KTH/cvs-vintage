...
public class SpamPanel extends DefaultPanel implements ActionListener {
    ...
    protected void initComponents() {
        ...
        addressCheckBox = new CheckBoxWithMnemonic(MailResourceLoader.getString(
            "dialog", "account", "dont_mark_message"));
        
        incomingCheckBox = new CheckBoxWithMnemonic(MailResourceLoader.getString(
            "dialog", "account", "move_incoming_messages"));
        ...
        incomingTrashRadioButton = new RadioButtonWithMnemonic(
            MailResourceLoader.getString("dialog", "account", "trash_folder"));
        ...
        markTrashRadioButton = new RadioButtonWithMnemonic(
            MailResourceLoader.getString("dialog", "account", "move_to_trash_folder"));
        markMoveToRadioButton = new RadioButtonWithMnemonic(
            MailResourceLoader.getString("dialog", "account", "move_to"));
...
FolderTreeModel.getInstance().getFolder(spam.getIncomingCustomFolder());
            String treePath = folder.getTreePath();
            incomingChooseFolderButton.setText(treePath);
            
            incomingMoveToRadioButton.setSelected(!spam.isIncomingTrashSelected());
            
            incomingTrashRadioButton.setSelected(spam.isIncomingTrashSelected());
            
            markCheckBox.setSelected(spam.isMoveMessageWhenMarkingEnabled());
            
            folder = (AbstractMessageFolder) FolderTreeModel.getInstance().getFolder(
            ...
            AbstractMessageFolder folder = (AbstractMessageFolder)
FolderTreeModel.getInstance().getFolder(list);
            ...
            folder = (AbstractMessageFolder) FolderTreeModel.getInstance().getFolder(list);
