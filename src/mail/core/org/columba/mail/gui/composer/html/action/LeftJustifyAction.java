 ...
 */
public class LeftJustifyAction extends AbstractSelectableAction
    ...
    public LeftJustifyAction(IFrameMediator frameMediator) {
        ...
        putValue(LARGE_ICON,
        		MailImageLoader.getIcon("format-justify-left.png"));
        putValue(SMALL_ICON,
        		MailImageLoader.getSmallIcon("format-justify-left.png"));
