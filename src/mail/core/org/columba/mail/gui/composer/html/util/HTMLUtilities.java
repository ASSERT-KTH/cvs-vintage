...
public class HTMLUtilities
{
	...
	/** Diese Methode löscht durch Stringmanipulation in jtpSource
	  * das übergebene Element, Alternative für removeElement in
	...
	/** 
	 * Diese Methode prüft ob der übergebene Tag sich in der 
	 ...
	 * übergebenen tags entsprechende Element zurück
	 */
	...
	/** 
	  ...
	  * gemäß den übergebenen Werten, und
