...
public class MessageTransferHandler extends TransferHandler {
	...
	String localFolderCommandReferenceType =
	...
	public MessageTransferHandler(TableController tableController) {
		...
		try {
			localFolderCommandReferenceFlavor =
				new DataFlavor(localFolderCommandReferenceType);
	...
	public boolean importData(JComponent c, Transferable t) {
		...
		try {
			...
			if (hasLocalArrayListFlavor(t.getTransferDataFlavors())) {
				reference =
					(FolderCommandReference[]) t.getTransferData(
						localFolderCommandReferenceFlavor);
		...
		*/
		...
		Folder destFolder = (Folder) target.getSelectionPath().getLastPathComponent();
	...
	protected Transferable createTransferable(JComponent c) {
		if (c instanceof JTable) {
			...
			FolderCommandReference[] r =
				tableController.getMailFrameController().getTableSelection();
