...
public class CreateVFolderOnSubjectAction
	...
	public CreateVFolderOnSubjectAction(AbstractFrameController frameController) {
		super(
				frameController,
		...
		setTooltipText(
				MailResourceLoader.getString(
					"menu", "mainframe", "menu_message_vfolderonsubject_tooltip"));
		
		// action command
		setActionCommand("VFOLDER_ON_SUBJECT");
