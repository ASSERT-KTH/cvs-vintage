...
public class TableView extends TreeTable {
    ...
    protected void initRenderer() throws Exception {
        ...
        for (int i = 0; i < tableItem.count(); i++) {
            ...
            if (r == null) {
                ...
                registerRenderer(name, r, new BasicHeaderRenderer(), size,
                    false, position);
            } else {
    ...
    public void registerRenderer(String name, DefaultLabelRenderer cell,
