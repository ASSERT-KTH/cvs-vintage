 ...
 * @author fdietz
 */
public class ToggleExpungedFlagAction extends AbstractColumbaAction implements
        ISelectionListener {

    public ToggleExpungedFlagAction(IFrameMediator frameMediator) {
        super(frameMediator, MailResourceLoader.getString("menu", "mainframe",
                "menu_message_toggleexpunged"));

        // tooltip text
        putValue(SHORT_DESCRIPTION, MailResourceLoader.getString("menu",
                "mainframe", "menu_message_toggleexpunged_tooltip").replaceAll(
                "&", ""));
