...
/**
 * Check if subject contains capital letters only
 * 
 * @author fdietz
 *  
 */
public class SubjectIsAllCapitalsRule extends AbstractRule {

    public SubjectIsAllCapitalsRule() {
        super("SubjectIsAllCapitalsRule");
    }
