...
*/
    ...
    public static Vector getScarabRModuleUsers(ParameterParser pp)
        throws Exception
    {
        Vector v = new Vector();
        ...
        while ( keys.hasMoreElements() )
        {
            ...
            if ("ScarabRModuleUser".equalsIgnoreCase(
                     parsedString[StringUtils.PPKEY_CLASSNAME]))
            {
                ScarabRModuleUser obj = null;
                if (parsedString[StringUtils.PPKEY_ID].equals("PK") )
                {
                    obj = new ScarabRModuleUser();
                    v.addElement(obj);
                ...
                else
                {
                    ...
                    {
                        ScarabRModuleUser tempObj = 
                            (ScarabRModuleUser)v.get(i);
                        if ( module_id == tempObj.getModuleId() && user_id == tempObj.getUserId() ) 
                        {
                            obj = tempObj;
                            break;
                        }
     ...
     * related objects to isNew=true.
      */
    public ScarabRModuleUser copy() throws Exception
    {
        ScarabRModuleUser copyObj = new ScarabRModuleUser();
         ...
         Vector v = copyObj.getScarabRModuleUserRoles();
         for (int i=0; i<v.size(); i++)
         {
