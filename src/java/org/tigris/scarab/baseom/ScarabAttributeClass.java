...
*/
    ...
    public static Vector getScarabAttributeClasss(ParameterParser pp)
        throws Exception
    {
        Vector v = new Vector();
        ...
        while ( keys.hasMoreElements() )
        {
            ...
            if ("ScarabAttributeClass".equalsIgnoreCase(
                     parsedString[StringUtils.PPKEY_CLASSNAME]))
            {
                ScarabAttributeClass obj = null;
                if (parsedString[StringUtils.PPKEY_ID].equals("PK") )
                {
                    obj = new ScarabAttributeClass();
                    v.addElement(obj);
  
                          obj.setAttributeClassId(Integer
                        .parseInt(parsedString[StringUtils.PPKEY_ID]));
                        }
                else
                {
  
                          int attribute_class_id = Integer
                        .parseInt(parsedString[StringUtils.PPKEY_ID]);
                    ...
                    {
                        ScarabAttributeClass tempObj = 
                            (ScarabAttributeClass)v.get(i);
                        if ( attribute_class_id == tempObj.getAttributeClassId() ) 
                        {
                            obj = tempObj;
                            break;
                        }
                    ...
                    {
                        obj = new ScarabAttributeClass();
                        obj.setAttributeClassId(attribute_class_id);
                        v.addElement(obj);
                    }
                }
                ...
                {
                    obj.setDesc(pp.getString(ppKey));
                }
