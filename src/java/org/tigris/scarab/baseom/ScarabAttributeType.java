...
public class ScarabAttributeType extends BaseObject
{
    ...
    void setScarabAttributeClass(ScarabAttributeClass v) throws Exception
    {
    ...
    {
        if (aScarabAttributeClass != null)
        {
            return aScarabAttributeClass;            
        }
        else if (this.attribute_class_id>0)
        {
...
//    private Vector tempcollScarabAttributes;
     ...
     * the collection. Otherwise if this ScarabAttributeType is new, it will return
    ...
    {
        return getScarabAttributes(new Criteria(5));
    }
...
*/
        ...
        else
        {
            ...
            boolean newCriteria = true;
                   criteria.add(ScarabAttributePeer.ATTRIBUTE_TYPE_ID, getAttributeTypeId() );               
               if ( lastScarabAttributesCriteria.size() == criteria.size() )
            {
                newCriteria = false;
                for (Enumeration e=criteria.keys(); e.hasMoreElements(); )
                {
                    Object key = e.nextElement();
                    if ( lastScarabAttributesCriteria.containsKey(key) )
                    {
                        if ( !criteria.get(key).equals(
                            lastScarabAttributesCriteria.get(key)) )
                        {
                            newCriteria = true;
                            break;
                        }
    ...
    {
        return "ScarabAttributeType[" + getId() + "]";
    }
