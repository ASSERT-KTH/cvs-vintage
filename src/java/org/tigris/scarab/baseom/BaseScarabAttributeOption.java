 ...
 * extended all references should be to ScarabAttributeOption 
 */
public abstract class BaseScarabAttributeOption extends BaseObject
{
...
//    private Vector tempcollScarabIssueAttributeValues;
    ...
    public void addScarabIssueAttributeValues(ScarabIssueAttributeValue l) throws Exception
    {
        ...
        */
        ...
        l.setScarabAttributeOption((ScarabAttributeOption)this);
    }
...
*/
    ...
    public void save(DBConnection dbCon) throws Exception
    {
        if (!alreadyInSave)
      {
          ...
          if (isModified())
        {
            if (isNew())
            {
                ScarabAttributeOptionPeer.doInsert((ScarabAttributeOption)this, dbCon);
            }
            else
            {
                ScarabAttributeOptionPeer.doUpdate((ScarabAttributeOption)this, dbCon);
                setNew(false);
            }
        }
    ...
    public ScarabAttributeOption copy() throws Exception
    {
        ScarabAttributeOption copyObj = new ScarabAttributeOption();
         ...
         List v = copyObj.getScarabIssueAttributeValues();
