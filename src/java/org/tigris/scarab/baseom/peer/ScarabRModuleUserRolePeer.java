...
import org.tigris.scarab.baseom.ScarabRModuleUserRole;
...
public class ScarabRModuleUserRolePeer extends BasePeer
{
    ...
    /** Create a new object of type cls from a resultset row starting
      ...
      */
    public static ScarabRModuleUserRole row2Object (Record row, int offset, Class cls ) throws Exception
    {
        ScarabRModuleUserRole obj = (ScarabRModuleUserRole)cls.newInstance();
    ...
    {
        criteria.setDbName(getMapBuilder().getDatabaseMap().getName());
        return doSelect (criteria,"org.tigris.scarab.baseom.ScarabRModuleUserRole", null);
    }
    ...
    {
        criteria.setDbName(getMapBuilder().getDatabaseMap().getName());
        return doSelect (criteria,"org.tigris.scarab.baseom.ScarabRModuleUserRole", dbCon);
    }
     ...
     * @param int role_id
     */
    public static ScarabRModuleUserRole retrieveById(Object id) 
        throws Exception
    {
    ...
    */
        ...
        throws Exception
    {
        ...
        for (int i=0; i<rows.size(); i++)
        {
            ScarabRModuleUserRole obj1 = 
                row2Object((com.workingdogs.village.Record)rows.elementAt(i),
                            1, Class.forName("org.tigris.scarab.baseom.ScarabRModuleUserRole") );
            ScarabRModuleUser obj2 = ScarabRModuleUserPeer
                .row2Object((com.workingdogs.village.Record)rows.elementAt(i),
                            offset, Class.forName("org.tigris.scarab.baseom.ScarabRModuleUser") );
