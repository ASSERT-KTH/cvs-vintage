...
public class ScarabAttributeOptionPeer extends BasePeer
{
    ...
    /** Create a new object of type cls from a resultset row starting
      ...
      */
    public static ScarabAttributeOption row2Object (Record row, int offset, Class cls ) throws Exception
    {
        ScarabAttributeOption obj = (ScarabAttributeOption)cls.newInstance();
    ...
    {
        criteria.setDbName(getMapBuilder().getDatabaseMap().getName());
        return doSelect (criteria,"org.tigris.scarab.baseom.ScarabAttributeOption", null);
    }
    ...
    {
        criteria.setDbName(getMapBuilder().getDatabaseMap().getName());
        return doSelect (criteria,"org.tigris.scarab.baseom.ScarabAttributeOption", dbCon);
    }
     ...
     * @param int option_id
     */
    public static ScarabAttributeOption retrieveById(Object id) 
        throws Exception
    {
    ...
    */
        ...
        throws Exception
    {
        ...
        for (int i=0; i<rows.size(); i++)
        {
            ScarabAttributeOption obj1 = 
                row2Object((com.workingdogs.village.Record)rows.elementAt(i),
                            1, Class.forName("org.tigris.scarab.baseom.ScarabAttributeOption") );
