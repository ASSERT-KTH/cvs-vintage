...
*/
    ...
    public static Vector getScarabIssueAttributeValues(ParameterParser pp)
        throws Exception
    {
        Vector v = new Vector();
        ...
        while ( keys.hasMoreElements() )
        {
            ...
            if ("ScarabIssueAttributeValue".equalsIgnoreCase(
                     parsedString[StringUtils.PPKEY_CLASSNAME]))
            {
                ScarabIssueAttributeValue obj = null;
                if (parsedString[StringUtils.PPKEY_ID].equals("PK") )
                {
                    obj = new ScarabIssueAttributeValue();
                    v.addElement(obj);
                ...
                else
                {
                    ...
                    {
                        ScarabIssueAttributeValue tempObj = 
                            (ScarabIssueAttributeValue)v.get(i);
                        if ( issue_id == tempObj.getIssueId() && attribute_id == tempObj.getAttributeId() ) 
                        {
                            obj = tempObj;
                            break;
                        }
                ...
                {
                    obj.setUserId(pp.getInt(ppKey));
                }
                        if ( property.equalsIgnoreCase("Value") ) 
                {
                    obj.setValue(pp.getString(ppKey));
                }
     ...
     * related objects to isNew=true.
      */
    public ScarabIssueAttributeValue copy() throws Exception
    {
        ScarabIssueAttributeValue copyObj = new ScarabIssueAttributeValue();
         ...
         Vector v = copyObj.getScarabIssueAttributeVotes();
         for (int i=0; i<v.size(); i++)
         {
