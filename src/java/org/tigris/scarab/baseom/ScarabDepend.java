...
public class ScarabDepend extends BaseObject
{
    ...
    void setScarabIssueRelatedByObservedId(ScarabIssue v) throws Exception
    {
    ...
    void setScarabIssueRelatedByObserverId(ScarabIssue v) throws Exception
    {
    ...
    void setScarabDependType(ScarabDependType v) throws Exception
    {
