...
*/
    ...
    public static Vector getScarabAttributes(ParameterParser pp)
        throws Exception
    {
        Vector v = new Vector();
        ...
        while ( keys.hasMoreElements() )
        {
            ...
            if ("ScarabAttribute".equalsIgnoreCase(
                     parsedString[StringUtils.PPKEY_CLASSNAME]))
            {
                ScarabAttribute obj = null;
                if (parsedString[StringUtils.PPKEY_ID].equals("PK") )
                {
                    obj = new ScarabAttribute();
                    v.addElement(obj);
  
                          obj.setAttributeId(Integer
                        .parseInt(parsedString[StringUtils.PPKEY_ID]));
                        }
                else
                {
  
                          int attribute_id = Integer
                        .parseInt(parsedString[StringUtils.PPKEY_ID]);
                    ...
                    {
                        ScarabAttribute tempObj = 
                            (ScarabAttribute)v.get(i);
                        if ( attribute_id == tempObj.getAttributeId() ) 
                        {
                            obj = tempObj;
                            break;
                        }
