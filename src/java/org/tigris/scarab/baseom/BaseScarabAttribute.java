 ...
 * extended all references should be to ScarabAttribute 
 */
public abstract class BaseScarabAttribute extends BaseObject
{
     ...
     */
     public void setAttributeId(int v ) throws Exception
     {
          ...
          if (collScarabAttributeOptions != null )
          {
              ...
              {
                  ((ScarabAttributeOption)collScarabAttributeOptions.get(i))
                      .setAttributeId(v);
              }
          }
    ...
    {
        if ( aScarabAttributeType==null && (this.attribute_type_id>0) )
        {
            aScarabAttributeType = ScarabAttributeTypePeer.retrieveByPK(this.attribute_type_id);
...
//    private Vector tempcollScarabActivitys;
    ...
    public void addScarabActivitys(ScarabActivity l) throws Exception
    {
        ...
        */
        ...
        l.setScarabAttribute((ScarabAttribute)this);
    }
...
*/
    ...
    public void save(DBConnection dbCon) throws Exception
    {
        if (!alreadyInSave)
      {
          ...
          if (isModified())
        {
            if (isNew())
            {
                ScarabAttributePeer.doInsert((ScarabAttribute)this, dbCon);
            }
            else
            {
                ScarabAttributePeer.doUpdate((ScarabAttribute)this, dbCon);
                setNew(false);
            }
        }
          ...
          if (collScarabAttributeOptions != null )
          {
              for (int i=0; i<collScarabAttributeOptions.size(); i++)
              {
                  ((ScarabAttributeOption)collScarabAttributeOptions.get(i)).save(dbCon);
              }
          }
    ...
    {
        return "ScarabAttribute[" + getPrimaryKey() + "]";
    }
