 ...
 * extended all references should be to ScarabRModuleUserRole 
 */
public abstract class BaseScarabRModuleUserRole extends BaseObject
{
    ...
    public void save(DBConnection dbCon) throws Exception
    {
        if (!alreadyInSave)
      {
          ...
          if (isModified())
        {
            if (isNew())
            {
                ScarabRModuleUserRolePeer.doInsert((ScarabRModuleUserRole)this, dbCon);
            }
            else
            {
                ScarabRModuleUserRolePeer.doUpdate((ScarabRModuleUserRole)this, dbCon);
                setNew(false);
            }
        }
