...
public abstract class BaseScarabModificationPeer extends BasePeer
{
    ...
    protected static final String CLASSNAME_DEFAULT = 
        "org.tigris.scarab.baseom.ScarabModification";
     ...
     */
    public static ScarabModification row2Object (Record row, 
                                              int offset, 
                                              String cls ) 
        throws Exception
    {
        ScarabModification obj = 
            (ScarabModification)Class.forName(cls).newInstance();
