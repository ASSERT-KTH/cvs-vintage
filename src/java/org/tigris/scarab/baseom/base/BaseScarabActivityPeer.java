...
/**
  ...
  *
  */
public abstract class BaseScarabActivityPeer extends BasePeer
{
    ...
    protected static final String CLASSNAME_DEFAULT = 
        "org.tigris.scarab.baseom.ScarabActivity";
     ...
     */
    public static ScarabActivity row2Object (Record row, 
                                              int offset, 
                                              String cls ) 
        throws Exception
    {
        ScarabActivity obj = 
            (ScarabActivity)Class.forName(cls).newInstance();
    ...
    */
        ...
        throws Exception
    {
        ...
        for (int i=0; i<rows.size(); i++)
        {
            ...
            ScarabActivity obj1 = row2Object( row,1, CLASSNAME_DEFAULT );
        ...
        throws Exception
    {
        ...
        for (int i=0; i<rows.size(); i++)
        {
            ...
            ScarabTransaction obj2 = ScarabTransactionPeer
                .row2Object(row, offset, 
                    ScarabTransactionPeer.CLASSNAME_DEFAULT);
