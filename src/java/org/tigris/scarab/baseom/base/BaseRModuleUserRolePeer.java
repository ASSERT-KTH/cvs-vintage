...
/**
  ...
  *
  */
public abstract class BaseRModuleUserRolePeer extends BasePeer
{
    /** the mapbuilder for this class */
    private static final RModuleUserRoleMapBuilder mapBuilder = 
        (RModuleUserRoleMapBuilder)getMapBuilder(RModuleUserRoleMapBuilder.CLASS_NAME);

    /** the table name for this class */
    public static final String TABLE_NAME = mapBuilder.getTable();

    /** the column name for the MODULE_ID field */
    public static final String MODULE_ID = mapBuilder.getRModuleUserRole_ModuleId();
    /** the column name for the USER_ID field */
    public static final String USER_ID = mapBuilder.getRModuleUserRole_UserId();
    /** the column name for the ROLE_ID field */
    public static final String ROLE_ID = mapBuilder.getRModuleUserRole_RoleId();
    /** the column name for the DELETED field */
    public static final String DELETED = mapBuilder.getRModuleUserRole_Deleted();
    ...
    protected static final String CLASSNAME_DEFAULT = 
        "org.tigris.scarab.baseom.RModuleUserRole";
     ...
     */
    public static RModuleUserRole row2Object (Record row, 
                                              int offset, 
                                              Class cls ) 
        throws Exception
    {
        RModuleUserRole obj = (RModuleUserRole)cls.newInstance();
                                                        obj.setModuleId(
    ...
    /** Method to do inserts */
    public static void doInsert( RModuleUserRole obj ) throws Exception
    {
     ...
     */
    public static void doUpdate(RModuleUserRole obj) throws Exception
    {
     ...
     */
    public static void doDelete(RModuleUserRole obj) throws Exception
    {
    ...
    /** 
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(RModuleUserRole) method.  It will take 
     * care of the connection details internally. 
     *
     * @param obj the data object to insert into the database.
     */
    public static void doInsert( RModuleUserRole obj, DBConnection dbCon) throws Exception
    {
     ...
     * otherwise use the doUpdate(RModuleUserRole) method.  It will take 
     * care of the connection details internally. 
     *
     * @param obj the data object to update in the database.
     */
    public static void doUpdate(RModuleUserRole obj, DBConnection dbCon) throws Exception
    {
        doUpdate(buildCriteria(obj), dbCon);
    }
    /**
     * Method to delete.  This method is to be used during a transaction,
     * otherwise use the doDelete(RModuleUserRole) method.  It will take 
     * care of the connection details internally. 
     *
     * @param obj the data object to delete in the database.
     */
    public static void doDelete(RModuleUserRole obj, DBConnection dbCon) throws Exception
    {
        doDelete(buildCriteria(obj), dbCon);
    }

    /** Build a Criteria object from the data object for this peer */
    public static Criteria buildCriteria( RModuleUserRole obj )
    {
     ...
     * @param ObjectKey pk
     */
    public static RModuleUserRole retrieveByPK( ObjectKey pk )
        throws Exception
    {
        Criteria criteria = new Criteria();
        ...
        {
            return (RModuleUserRole)v.firstElement();
        }
    }
     ...
     */
    public static RModuleUserRole retrieveByPK(
     SimpleKey module_id
            , SimpleKey user_id
            , SimpleKey role_id
                ) throws Exception
   ...
   /**
    * selects a collection of RModuleUserRole objects pre-filled with their
    * RModuleUser objects.
    */
    public static Vector doSelectJoinRModuleUser(Criteria c)
        throws Exception
    {
        ...
        RModuleUserPeer.addSelectColumns(c);
        ...
        for (int i=0; i<rows.size(); i++)
        {
            ...
            RModuleUserRole obj1 = row2Object( row,1, CLASS_DEFAULT );


            RModuleUser obj2 = RModuleUserPeer
                .row2Object(row, offset, 
                    RModuleUserPeer.CLASS_DEFAULT);
            
            boolean newObject = true;
            for (int j=0; j<results.size(); j++)
            {
                RModuleUserRole temp_obj1 = (RModuleUserRole)results.elementAt(j);
                RModuleUser temp_obj2 = temp_obj1.getRModuleUser();
                if ( temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey() ) )
                {
                    newObject = false;
                    temp_obj2.addRModuleUserRoles(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initRModuleUserRoles();
                obj2.addRModuleUserRoles(obj1);
            }
            results.add(obj1);
