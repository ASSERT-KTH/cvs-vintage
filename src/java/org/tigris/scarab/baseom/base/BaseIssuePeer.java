...
/**
  ...
  *
  */
public abstract class BaseIssuePeer extends BasePeer
{
    /** the mapbuilder for this class */
    private static final IssueMapBuilder mapBuilder = 
        (IssueMapBuilder)getMapBuilder(IssueMapBuilder.CLASS_NAME);

    /** the table name for this class */
    public static final String TABLE_NAME = mapBuilder.getTable();

    /** the column name for the ISSUE_ID field */
    public static final String ISSUE_ID = mapBuilder.getIssue_IssueId();
    /** the column name for the MODULE_ID field */
    public static final String MODULE_ID = mapBuilder.getIssue_ModuleId();
    /** the column name for the MODIFIED_BY field */
    public static final String MODIFIED_BY = mapBuilder.getIssue_ModifiedBy();
    /** the column name for the CREATED_BY field */
    public static final String CREATED_BY = mapBuilder.getIssue_CreatedBy();
    /** the column name for the MODIFIED_DATE field */
    public static final String MODIFIED_DATE = mapBuilder.getIssue_ModifiedDate();
    /** the column name for the CREATED_DATE field */
    public static final String CREATED_DATE = mapBuilder.getIssue_CreatedDate();
    /** the column name for the DELETED field */
    public static final String DELETED = mapBuilder.getIssue_Deleted();
    ...
    protected static final String CLASSNAME_DEFAULT = 
        "org.tigris.scarab.baseom.Issue";
    ...
    /** Method to do inserts */
    public static void doInsert( Issue obj ) throws Exception
    {
     ...
     */
    public static void doUpdate(Issue obj) throws Exception
    {
     ...
     */
    public static void doDelete(Issue obj) throws Exception
    {
     ...
     */
    public static void doInsert( Issue obj, DBConnection dbCon) throws Exception
    {
     ...
     * @param obj the data object to update in the database.
     */
    public static void doUpdate(Issue obj, DBConnection dbCon) throws Exception
    {
     ...
     * @param obj the data object to delete in the database.
     */
    public static void doDelete(Issue obj, DBConnection dbCon) throws Exception
    {
    ...
    */
        ...
        throws Exception
    {
        ...
        for (int i=0; i<rows.size(); i++)
        {
            ...
            Issue obj1 = row2Object( row,1, CLASS_DEFAULT );
            ...
            {
                Issue temp_obj1 = (Issue)results.elementAt(j);
                Module temp_obj2 = temp_obj1.getModule();
                if ( temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey() ) )
                {
                    newObject = false;
                    temp_obj2.addIssues(obj1);
                    break;
                }
            }
            if (newObject)
    ...
    * TurbineUser objects.
    */
    public static Vector doSelectJoinTurbineUserRelatedByCreatedBy(Criteria c)
        throws Exception
    {
         c.setDbName(mapBuilder.getDatabaseMap().getName());
        ...
        for (int i=0; i<rows.size(); i++)
        {
            ...
            {
                Issue temp_obj1 = (Issue)results.elementAt(j);
                TurbineUser temp_obj2 = temp_obj1.getTurbineUserRelatedByCreatedBy();
                if ( temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey() ) )
                {
                    newObject = false;
                    temp_obj2.addIssuesRelatedByCreatedBy(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initIssuesRelatedByCreatedBy();
                obj2.addIssuesRelatedByCreatedBy(obj1);
            }
            results.add(obj1);
    ...
    * TurbineUser objects.
    */
    public static Vector doSelectJoinTurbineUserRelatedByModifiedBy(Criteria c)
        throws Exception
    {
         c.setDbName(mapBuilder.getDatabaseMap().getName());
        ...
        for (int i=0; i<rows.size(); i++)
        {
            ...
            {
                Issue temp_obj1 = (Issue)results.elementAt(j);
                TurbineUser temp_obj2 = temp_obj1.getTurbineUserRelatedByModifiedBy();
                if ( temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey() ) )
                {
                    newObject = false;
                    temp_obj2.addIssuesRelatedByModifiedBy(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initIssuesRelatedByModifiedBy();
                obj2.addIssuesRelatedByModifiedBy(obj1);
            }
            results.add(obj1);
    ...
    */
        ...
        throws Exception
    {
        ...
        for (int i=0; i<rows.size(); i++)
        {
            ...
            {
                Issue temp_obj1 = (Issue)results.elementAt(j);
                TurbineUser temp_obj3 = temp_obj1.getTurbineUserRelatedByModifiedBy();
                if ( temp_obj3.getPrimaryKey().equals(obj3.getPrimaryKey() ) )
                {
                    newObject = false;
                    temp_obj3.addIssuesRelatedByModifiedBy(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initIssuesRelatedByModifiedBy();
                obj3.addIssuesRelatedByModifiedBy(obj1);
            }
                        results.add(obj1);
    ...
    * all related objects.
    */
    public static Vector doSelectJoinAllExceptTurbineUserRelatedByCreatedBy(Criteria c) 
        throws Exception
    {
         c.setDbName(mapBuilder.getDatabaseMap().getName());
        ...
        int offset2 = numColumns + 1;
                ...
                ModulePeer.addSelectColumns(c);
        int offset3 = offset2 + ModulePeer.numColumns;
    ...
    * all related objects.
    */
    public static Vector doSelectJoinAllExceptTurbineUserRelatedByModifiedBy(Criteria c) 
        throws Exception
    {
         c.setDbName(mapBuilder.getDatabaseMap().getName());
