...
public abstract class BaseScarabIssuePeer extends BasePeer
{
    ...
    protected static final String CLASSNAME_DEFAULT = 
        "org.tigris.scarab.baseom.ScarabIssue";
     ...
     */
    public static ScarabIssue row2Object (Record row, 
                                              int offset, 
                                              String cls ) 
        throws Exception
    {
        ScarabIssue obj = 
            (ScarabIssue)Class.forName(cls).newInstance();
    ...
    */
        ...
        throws Exception
    {
        ...
        for (int i=0; i<rows.size(); i++)
        {
            ...
            ScarabIssue obj1 = row2Object( row,1, CLASSNAME_DEFAULT );
