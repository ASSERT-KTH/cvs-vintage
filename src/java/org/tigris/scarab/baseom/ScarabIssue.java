...
*/
    ...
    public static Vector getScarabIssues(ParameterParser pp)
        throws Exception
    {
        Vector v = new Vector();
                     ...
                     parsedString[StringUtils.PPKEY_CLASSNAME]))
            {
                ...
                else
                {
                    ...
                    for ( int i=0; i<v.size(); i++) 
                    {
                        ScarabIssue tempObj = 
                            (ScarabIssue)v.get(i);
                        if ( issue_id == tempObj.getIssueId() ) 
                        {
                            obj = tempObj;
                            break;
                        }
                ...
                String property = parsedString[StringUtils.PPKEY_PROPERTY];
                        ...
                        if ( property.equalsIgnoreCase("ModuleId") ) 
                {
                    obj.setModuleId(pp.getInt(ppKey));
                }
