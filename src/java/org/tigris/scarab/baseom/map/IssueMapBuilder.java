...
public class IssueMapBuilder implements MapBuilder
{
    ...
    public static final String CLASS_NAME = "org.tigris.scarab.baseom.map.IssueMapBuilder";
    ...
    */
    ...
    public void doBuild ( ) throws Exception
    {
        ...
        tMap.setPrimaryKeyMethodInfo(tMap.getName());
                  ...
                  tMap.addColumn ( getIssue_ModifiedBy(), new Integer(0) );
          
                  tMap.addColumn ( getIssue_CreatedBy(), new Integer(0) );
