...
public class ModuleMapBuilder implements MapBuilder
{
    ...
    public static final String CLASS_NAME = "org.tigris.scarab.baseom.map.ModuleMapBuilder";
    ...
    */
    ...
    public void doBuild ( ) throws Exception
    {
        ...
        tMap.setPrimaryKeyMethodInfo(tMap.getName());
                  ...
                  tMap.addColumn ( getModule_OwnerId(), new Integer(0) );
          
                  tMap.addColumn ( getModule_QaContactId(), new Integer(0) );
