    ...
    */
    ...
    public void doBuild ( ) throws Exception
    {
        ...
        tMap.setPrimaryKeyMethod(tMap.IDBROKERTABLE);
                  ...
                  tMap.addPrimaryKey ( getScarabIssue_IssueId(), integer );
          
                  tMap.addForeignKey ( getScarabIssue_ModuleId(), integer , "SCARAB_MODULE" , "MODULE_ID" );
          
                  tMap.addColumn ( getScarabIssue_ModifiedBy(), integer );
          
                  tMap.addColumn ( getScarabIssue_CreatedBy(), integer );
          
                  tMap.addColumn ( getScarabIssue_ModifiedDate(), date );
          
                  tMap.addColumn ( getScarabIssue_CreatedDate(), date );
          
                  tMap.addColumn ( getScarabIssue_Deleted(), string );
