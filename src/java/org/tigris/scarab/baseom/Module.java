...
/** 
  ...
  */
public class Module 
    extends org.tigris.scarab.baseom.base.BaseModule
{
        ...
        throws Exception
    {
        ...
        issue.setModifiedBy((SimpleKey)user.getPrimaryKey());
        issue.setCreatedBy((SimpleKey)user.getPrimaryKey());
    ...
    */
        ...
        throws Exception
    {
        ...
        setOwnerId( new SimpleKey(data.getParameters().getString(prefix + "ownerid") ));
        setQaContactId( new SimpleKey(data.getParameters()
