    ...
    extends BasePeer
{
    ...
    protected static final String CLASSNAME_DEFAULT =
        "org.apache.fulcrum.security.impl.db.entity.TurbineUserGroupRole";
        ...
        throws TorqueException
    {
        try
        {
                obj.setUserId(row.getValue(offset + 0).asIntegerObj());
                  ...
                  obj.setRoleId(row.getValue(offset + 2).asIntegerObj());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinTurbineUser(Criteria c)
        throws TorqueException
    {
        // Set the correct dbName if it has not been overridden
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinTurbineGroup(Criteria c)
        throws TorqueException
    {
        // Set the correct dbName if it has not been overridden
        // c.getDbName will return the same object if not set to
