...
insert into SCARAB_MODULE(MODULE_ID, MODULE_NAME, MODULE_CODE, MODULE_DESCRIPTION, MODULE_URL, PARENT_ID, OWNER_ID, QA_CONTACT_ID) 
    values(6, 'Turbine Source', 'TBNS', 'Source', '/Turbine/source/', 3, 2, 2);
 ...
 * dedupe, quick_search
 */
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES (6,1,'Description',1,1,100,0,1);
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES (6,2,'Assigned To',0,0,200,0,0);
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES (6,3,'Status',1,0,300,0,0);
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES (6,4,'Resolution',1,0,400,0,0);
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES (6,5,'Platform',1,1,2,1,1);
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES 
    (6,6,'Operating System',1,1,3,1,1);
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES (6,7,'Priority',1,0,500,0,0);
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES (6,8,'Vote',0,0,600,0,0);
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES (6,9,'Severity',1,0,700,0,0);
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES (6,10,'Tracking',0,0,800,0,0);
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES (6,11,'Summary',1,1,1,1,1);
INSERT INTO SCARAB_R_MODULE_ATTRIBUTE VALUES (6,12,'Functional Area',0,0,1000,0,0);
...
/*
 * Also insert relationships between users 2,4,5 and modules 5 and 6
 * Using the Scarab_R_MODULE_USER_ROLE table for now so can do selects.
 */
insert into SCARAB_R_MODULE_USER_ROLE values (5, 2, 2, 0);
insert into SCARAB_R_MODULE_USER_ROLE values (6, 2, 2, 0);
insert into SCARAB_R_MODULE_USER_ROLE values (5, 4, 2, 0);
insert into SCARAB_R_MODULE_USER_ROLE values (6, 4, 2, 0);
insert into SCARAB_R_MODULE_USER_ROLE values (5, 5, 2, 0);
insert into SCARAB_R_MODULE_USER_ROLE values (6, 5, 2, 0);
...
insert into SCARAB_ISSUE_ATTRIBUTE_VALUE(VALUE_ID, ISSUE_ID, ATTRIBUTE_ID, OPTION_ID, VALUE) values (10, 1, 12, 88, 'UI');
