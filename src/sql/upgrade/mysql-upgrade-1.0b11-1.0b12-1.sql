...
ALTER TABLE SCARAB_ISSUE_TYPE ADD LOCKED INTEGER null;
ALTER TABLE SCARAB_ISSUE_TYPE ADD DEDUPE INTEGER null;
...
ALTER TABLE SCARAB_ATTRIBUTE_GROUP DROP MODULE_ID;
ALTER TABLE SCARAB_ATTRIBUTE_GROUP ADD MODULE_ID INTEGER null;
