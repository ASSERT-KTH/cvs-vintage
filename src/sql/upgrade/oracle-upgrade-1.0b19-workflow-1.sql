...
CREATE TABLE SCARAB_CONDITION (
  TRANSITION_ID NUMBER NOT NULL default '0',
  MODULE_ID NUMBER NOT NULL default '0',
  ISSUE_TYPE_ID NUMBER NOT NULL default '0',
  ATTRIBUTE_ID NUMBER NOT NULL default '0',
  OPTION_ID NUMBER NOT NULL default '0',
