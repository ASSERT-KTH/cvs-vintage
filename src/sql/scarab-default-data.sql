...
insert into SCARAB_ISSUE_TYPE(ISSUE_TYPE_ID, NAME, DESCRIPTION, PARENT_ID, ISDEFAULT)
        values(1, 'Defect', 'An issue in existing feature/functionality.', 0, 1);
insert into SCARAB_ISSUE_TYPE(ISSUE_TYPE_ID, NAME, DESCRIPTION, PARENT_ID, ISDEFAULT)
        values(2, 'Defect Template', '', 1,0);
insert into SCARAB_ISSUE_TYPE(ISSUE_TYPE_ID, NAME, DESCRIPTION, PARENT_ID, ISDEFAULT)
        values(3, 'Patch', 'A patch submitted to fix a defect.', 0, 1);
insert into SCARAB_ISSUE_TYPE(ISSUE_TYPE_ID, NAME, DESCRIPTION, PARENT_ID, ISDEFAULT)
        values(4, 'Patch Template', '', 3, 0);
insert into SCARAB_ISSUE_TYPE(ISSUE_TYPE_ID, NAME, DESCRIPTION, PARENT_ID, ISDEFAULT)
        values(5, 'Task', 'A task associated with instantiation, or in support of a Feature/Enhancement/Issue.', 0, 1);
insert into SCARAB_ISSUE_TYPE(ISSUE_TYPE_ID, NAME, DESCRIPTION, PARENT_ID, ISDEFAULT)
        values(6, 'Task Template', '', 5, 0);
insert into SCARAB_ISSUE_TYPE(ISSUE_TYPE_ID, NAME, DESCRIPTION, PARENT_ID, ISDEFAULT)
        values(7, 'Feature', 'A new feature.', 0, 1);
insert into SCARAB_ISSUE_TYPE(ISSUE_TYPE_ID, NAME, DESCRIPTION, PARENT_ID, ISDEFAULT)
        values(8, 'Feature Template', '', 7, 0);
insert into SCARAB_ISSUE_TYPE(ISSUE_TYPE_ID, NAME, DESCRIPTION, PARENT_ID, ISDEFAULT)
        values(9, 'Enhancement', 'Improvement to an existing feature.', 0, 1);
insert into SCARAB_ISSUE_TYPE(ISSUE_TYPE_ID, NAME, DESCRIPTION, PARENT_ID, ISDEFAULT)
        values(10, 'Enhancement Template', '', 9, 0);
...
INSERT INTO SCARAB_R_MODULE_ISSUE_TYPE (MODULE_ID, ISSUE_TYPE_ID, ACTIVE, DISPLAY, PREFERRED_ORDER) VALUES (0,4,1,1,2);
INSERT INTO SCARAB_R_MODULE_ISSUE_TYPE (MODULE_ID, ISSUE_TYPE_ID, ACTIVE, DISPLAY, PREFERRED_ORDER) VALUES (0,5,1,1,3);
INSERT INTO SCARAB_R_MODULE_ISSUE_TYPE (MODULE_ID, ISSUE_TYPE_ID, ACTIVE, DISPLAY, PREFERRED_ORDER) VALUES (0,6,1,1,3);
INSERT INTO SCARAB_R_MODULE_ISSUE_TYPE (MODULE_ID, ISSUE_TYPE_ID, ACTIVE, DISPLAY, PREFERRED_ORDER) VALUES (0,7,1,1,4);
INSERT INTO SCARAB_R_MODULE_ISSUE_TYPE (MODULE_ID, ISSUE_TYPE_ID, ACTIVE, DISPLAY, PREFERRED_ORDER) VALUES (0,8,1,1,4);
INSERT INTO SCARAB_R_MODULE_ISSUE_TYPE (MODULE_ID, ISSUE_TYPE_ID, ACTIVE, DISPLAY, PREFERRED_ORDER) VALUES (0,9,1,1,5);
INSERT INTO SCARAB_R_MODULE_ISSUE_TYPE (MODULE_ID, ISSUE_TYPE_ID, ACTIVE, DISPLAY, PREFERRED_ORDER) VALUES (0,10,1,1,5);
