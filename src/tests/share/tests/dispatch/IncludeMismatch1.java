/* $Id: IncludeMismatch1.java,v 1.1 1999/10/09 00:20:57 duncan Exp $
 */
...
public class IncludeMismatch1 implements Testable {

    public String getDescription() {
        return "IncludeMismatch1 Test";
    }
	...
	TestResult testResult = new TestResult();
  	try {
	    URL url =
		URLHelper.getURL("/servlet/dispatch.IncludeMismatch1");
