/*
 * $Header: /tmp/cvs-vintage/struts/src/test/org/apache/struts/taglib/html/TestPasswordTag2.java,v 1.1 2004/09/23 00:37:23 niallp Exp $
 * $Revision: 1.1 $
 ...
 * <code>org.apache.struts.taglib.html.PasswordTag</code> class.
 *
 */
public class TestPasswordTag2 extends JspTestCase {
    ...
    public static void main(String[] theArgs) {
        junit.awtui.TestRunner.main(new String[] {TestPasswordTag2.class.getName()});
    }
    ...
    private void runMyTest(String whichTest, String locale) throws Exception {
        ...
        pageContext.forward("/test/org/apache/struts/taglib/html/TestPasswordTag2.jsp");
    }
    ...
    public void testPasswordPropertyIndexedEnumerationProperty() throws Exception {
        SimpleBeanForTesting sbft = new SimpleBeanForTesting();
        StringTokenizer st = new StringTokenizer("Test Message");
