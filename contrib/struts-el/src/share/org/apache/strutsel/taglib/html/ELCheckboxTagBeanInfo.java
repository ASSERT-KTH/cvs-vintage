/*
 * $Header: /tmp/cvs-vintage/struts/contrib/struts-el/src/share/org/apache/strutsel/taglib/html/ELCheckboxTagBeanInfo.java,v 1.4 2004/03/14 07:15:01 sraeburn Exp $
 * $Revision: 1.4 $
...
public class ELCheckboxTagBeanInfo extends SimpleBeanInfo
{
    public  PropertyDescriptor[] getPropertyDescriptors()
    {
        ...
        try {
            proplist.add(new PropertyDescriptor("accesskey", ELCheckboxTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("onchange", ELCheckboxTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("ondblclick", ELCheckboxTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("onkeydown", ELCheckboxTag.class,
                                                null, "setOnkeydownExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onkeypress", ELCheckboxTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("onmousedown", ELCheckboxTag.class,
                                                null, "setOnmousedownExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onmousemove", ELCheckboxTag.class,
                                                null, "setOnmousemoveExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onmouseout", ELCheckboxTag.class,
                                                null, "setOnmouseoutExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onmouseover", ELCheckboxTag.class,
                                                null, "setOnmouseoverExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onmouseup", ELCheckboxTag.class,
                                                null, "setOnmouseupExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("property", ELCheckboxTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("styleClass", ELCheckboxTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("tabindex", ELCheckboxTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("titleKey", ELCheckboxTag.class,
