/*
 * $Header: /tmp/cvs-vintage/struts/contrib/struts-el/src/share/org/apache/strutsel/taglib/html/ELSubmitTagBeanInfo.java,v 1.4 2004/03/14 07:15:01 sraeburn Exp $
 * $Revision: 1.4 $
...
public class ELSubmitTagBeanInfo extends SimpleBeanInfo
{
    public  PropertyDescriptor[] getPropertyDescriptors()
    {
        ...
        try {
            proplist.add(new PropertyDescriptor("alt", ELSubmitTag.class,
                                                null, "setAltExpr"));
        } catch (IntrospectionException ex) {}
        try {
        ...
        try {
            proplist.add(new PropertyDescriptor("ondblclick", ELSubmitTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("onkeypress", ELSubmitTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("onmousedown", ELSubmitTag.class,
                                                null, "setOnmousedownExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onmousemove", ELSubmitTag.class,
                                                null, "setOnmousemoveExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onmouseout", ELSubmitTag.class,
                                                null, "setOnmouseoutExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onmouseover", ELSubmitTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("styleClass", ELSubmitTag.class,
