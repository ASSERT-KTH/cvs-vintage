/*
 * $Header: /tmp/cvs-vintage/struts/contrib/struts-el/src/share/org/apache/strutsel/taglib/bean/ELIncludeTagBeanInfo.java,v 1.4 2004/03/14 07:15:04 sraeburn Exp $
 * $Revision: 1.4 $
...
public class ELIncludeTagBeanInfo extends SimpleBeanInfo
{
    public  PropertyDescriptor[] getPropertyDescriptors()
    {
        ...
        try {
            proplist.add(new PropertyDescriptor("name", ELIncludeTag.class,
                                                null, "setNameExpr"));
        } catch (IntrospectionException ex) {}
        try {
