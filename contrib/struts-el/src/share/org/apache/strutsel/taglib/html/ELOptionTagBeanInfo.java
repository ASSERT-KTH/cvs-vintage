/*
 * $Header: /tmp/cvs-vintage/struts/contrib/struts-el/src/share/org/apache/strutsel/taglib/html/ELOptionTagBeanInfo.java,v 1.5 2004/03/14 07:15:01 sraeburn Exp $
 * $Revision: 1.5 $
...
public class ELOptionTagBeanInfo extends SimpleBeanInfo
{
    public  PropertyDescriptor[] getPropertyDescriptors()
    {
        ...
        try {
            proplist.add(new PropertyDescriptor("key", ELOptionTag.class,
                                                null, "setKeyExpr"));
        } catch (IntrospectionException ex) {}
        try {
        ...
        try {
            proplist.add(new PropertyDescriptor("styleClass", ELOptionTag.class,
