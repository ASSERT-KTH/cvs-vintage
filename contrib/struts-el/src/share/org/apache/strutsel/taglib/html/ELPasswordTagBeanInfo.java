/*
 * $Header: /tmp/cvs-vintage/struts/contrib/struts-el/src/share/org/apache/strutsel/taglib/html/ELPasswordTagBeanInfo.java,v 1.4 2004/03/14 07:15:01 sraeburn Exp $
 * $Revision: 1.4 $
...
public class ELPasswordTagBeanInfo extends SimpleBeanInfo
{
    public  PropertyDescriptor[] getPropertyDescriptors()
    {
        ...
        try {
            proplist.add(new PropertyDescriptor("accesskey", ELPasswordTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("disabled", ELPasswordTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("maxlength", ELPasswordTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("onchange", ELPasswordTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("ondblclick", ELPasswordTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("onkeydown", ELPasswordTag.class,
                                                null, "setOnkeydownExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onkeypress", ELPasswordTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("onmousedown", ELPasswordTag.class,
                                                null, "setOnmousedownExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onmousemove", ELPasswordTag.class,
                                                null, "setOnmousemoveExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onmouseout", ELPasswordTag.class,
                                                null, "setOnmouseoutExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onmouseover", ELPasswordTag.class,
                                                null, "setOnmouseoverExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("onmouseup", ELPasswordTag.class,
                                                null, "setOnmouseupExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("property", ELPasswordTag.class,
                                                null, "setPropertyExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("readonly", ELPasswordTag.class,
                                                null, "setReadonlyExpr"));
        } catch (IntrospectionException ex) {}
        try {
            proplist.add(new PropertyDescriptor("redisplay", ELPasswordTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("styleClass", ELPasswordTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("tabindex", ELPasswordTag.class,
        ...
        try {
            proplist.add(new PropertyDescriptor("titleKey", ELPasswordTag.class,
