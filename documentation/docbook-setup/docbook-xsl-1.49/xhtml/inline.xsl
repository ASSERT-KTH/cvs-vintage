...
<!-- ********************************************************************
     $Id: inline.xsl,v 1.1 2002/03/15 15:29:29 jeremybennett Exp $
     ********************************************************************
...
<xsl:template name="inline.monoseq">
  ...
  <tt xmlns="http://www.w3.org/1999/xhtml"><xsl:copy-of select="$content"/></tt>
</xsl:template>
...
<xsl:template name="inline.boldseq">
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <b xmlns="http://www.w3.org/1999/xhtml"><xsl:copy-of select="$content"/></b>
    </xsl:otherwise>
  </xsl:choose>
</xsl:template>
...
<xsl:template name="inline.italicseq">
  ...
  <i xmlns="http://www.w3.org/1999/xhtml"><xsl:copy-of select="$content"/></i>
</xsl:template>
...
<xsl:template name="inline.boldmonoseq">
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <b xmlns="http://www.w3.org/1999/xhtml"><tt><xsl:copy-of select="$content"/></tt></b>
    </xsl:otherwise>
  </xsl:choose>
</xsl:template>
...
<xsl:template name="inline.italicmonoseq">
  ...
  <i xmlns="http://www.w3.org/1999/xhtml"><tt><xsl:copy-of select="$content"/></tt></i>
</xsl:template>
...
<xsl:template name="inline.superscriptseq">
  ...
  <sup xmlns="http://www.w3.org/1999/xhtml"><xsl:copy-of select="$content"/></sup>
</xsl:template>
...
<xsl:template name="inline.subscriptseq">
  ...
  <sub xmlns="http://www.w3.org/1999/xhtml"><xsl:copy-of select="$content"/></sub>
</xsl:template>
...
<xsl:template match="author">
  <span xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}"><xsl:call-template name="person.name"/></span>
</xsl:template>
...
<xsl:template match="trademark">
  ...
  <xsl:choose>
    ...
    <xsl:when test="@class = 'service'">
      <sup xmlns="http://www.w3.org/1999/xhtml">SM</sup>
    </xsl:when>
    <xsl:otherwise>
      <xsl:call-template name="dingbat">
...
<xsl:template match="glossterm" name="glossterm">
  ...
  <xsl:choose>
    ...
    <xsl:when test="not(@linkend)                     and ($firstterm.only.link = 0 or $firstterm = 1)                     and $glossary.collection != ''">
    ...
    <xsl:when test="not(@linkend)                     and ($firstterm.only.link = 0 or $firstterm = 1)                     and $glossterm.auto.link != 0">
      ...
      <xsl:variable name="targets" select="//glossentry[glossterm=$term or glossterm/@baseform=$term]"/>
      <xsl:variable name="target" select="$targets[1]"/>
...
<xsl:template match="comment|remark">
  <xsl:if test="$show.comments != 0">
    <i xmlns="http://www.w3.org/1999/xhtml"><xsl:call-template name="inline.charseq"/></i>
  </xsl:if>
</xsl:template>
