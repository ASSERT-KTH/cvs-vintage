...
<!-- ********************************************************************
     $Id: sections.xsl,v 1.1 2002/03/15 15:29:29 jeremybennett Exp $
     ********************************************************************
...
<xsl:template match="sect1">
  <div xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}">
    ...
    <xsl:if test="($generate.section.toc != '0'                    and $generate.section.toc.level &gt;= 1)                   or refentry">
      <xsl:call-template name="section.toc"/>
    </xsl:if>
    <xsl:apply-templates/>
    <xsl:call-template name="process.chunk.footnotes"/>
...
<xsl:template match="sect2">
  <div xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}">
    ...
    <xsl:if test="($generate.section.toc != '0'                    and $generate.section.toc.level &gt;= 2)                   or refentry">
      <xsl:call-template name="section.toc"/>
    </xsl:if>
    <xsl:apply-templates/>
  </div>
...
<xsl:template match="sect3">
  <div xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}">
    ...
    <xsl:if test="($generate.section.toc != '0'                    and $generate.section.toc.level &gt;= 3)                   or refentry">
      <xsl:call-template name="section.toc"/>
    </xsl:if>
    <xsl:apply-templates/>
  </div>
...
<xsl:template match="sect4">
  <div xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}">
    ...
    <xsl:if test="($generate.section.toc != '0'                    and $generate.section.toc.level &gt;= 4)                   or refentry">
      <xsl:call-template name="section.toc"/>
    </xsl:if>
    <xsl:apply-templates/>
  </div>
...
<xsl:template match="sect5">
  <div xmlns="http://www.w3.org/1999/xhtml" class="{name(.)}">
    ...
    <xsl:if test="($generate.section.toc != '0'                    and $generate.section.toc.level &gt;= 5)                   or refentry">
      <xsl:call-template name="section.toc"/>
    </xsl:if>
    <xsl:apply-templates/>
  </div>
...
<xsl:template match="bridgehead">
  ...
  <xsl:variable name="clevel">
    <xsl:choose>
      <xsl:when test="local-name($container) = 'appendix'                       or local-name($container) = 'chapter'                       or local-name($container) = 'article'                       or local-name($container) = 'bibliography'                       or local-name($container) = 'glossary'                       or local-name($container) = 'index'                       or local-name($container) = 'partintro'                       or local-name($container) = 'preface'                       or local-name($container) = 'setindex'">2</xsl:when>
