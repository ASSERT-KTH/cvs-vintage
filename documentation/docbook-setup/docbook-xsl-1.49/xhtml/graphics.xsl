...
<!-- ********************************************************************
     $Id: graphics.xsl,v 1.1 2002/03/15 15:29:29 jeremybennett Exp $
     ********************************************************************
  ...
  <xsl:choose>
    <xsl:when test="@format='linespecific'">
      <xsl:choose>
        ...
        <xsl:otherwise>
          <a xmlns="http://www.w3.org/1999/xhtml" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad" href="{$filename}"/>
        </xsl:otherwise>
      </xsl:choose>
    </xsl:when>
    <xsl:otherwise>
...
<xsl:template name="longdesc.link">
  ...
  <div xmlns="http://www.w3.org/1999/xhtml" class="longdesc-link" align="right">
    <br clear="all"/>
