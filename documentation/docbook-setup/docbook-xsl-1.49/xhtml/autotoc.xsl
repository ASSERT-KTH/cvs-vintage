...
<!-- ********************************************************************
     $Id: autotoc.xsl,v 1.1 2002/03/15 15:29:29 jeremybennett Exp $
     ********************************************************************
...
<xsl:template name="division.toc">
  <xsl:if test="$generate.division.toc != 0">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:variable name="nodes" select="part|reference                                            |preface|chapter|appendix                                            |article                                            |bibliography|glossary|index                                            |refentry                                            |bridgehead"/>
        <xsl:if test="$nodes">
          <div xmlns="http://www.w3.org/1999/xhtml" class="toc">
            <xsl:copy-of select="$toc.title"/>
            <xsl:element name="{$toc.list.type}" namespace="http://www.w3.org/1999/xhtml">
...
<xsl:template name="component.toc">
  <xsl:if test="$generate.component.toc != 0">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:variable name="nodes" select="section|sect1|refentry                                            |article|bibliography|glossary                                            |appendix|bridgehead[not(@renderas)]                                            |.//bridgehead[@renderas='sect1']"/>
        <xsl:if test="$nodes">
          <div xmlns="http://www.w3.org/1999/xhtml" class="toc">
            <xsl:copy-of select="$toc.title"/>
            <xsl:element name="{$toc.list.type}" namespace="http://www.w3.org/1999/xhtml">
...
<xsl:template name="subtoc">
  ...
  <xsl:element name="{$toc.listitem.type}" namespace="http://www.w3.org/1999/xhtml">
    ...
    <xsl:if test="$toc.listitem.type = 'li'                   and $toc.section.depth&gt;0 and count($nodes)&gt;0">
...
<xsl:template match="book|setindex" mode="toc">
  <xsl:call-template name="subtoc">
    <xsl:with-param name="nodes" select="part|reference                                          |preface|chapter|appendix                                          |article                                          |bibliography|glossary|index                                          |refentry                                          |bridgehead"/>
  </xsl:call-template>
</xsl:template>

<xsl:template match="part|reference" mode="toc">
  <xsl:call-template name="subtoc">
    <xsl:with-param name="nodes" select="appendix|chapter|article                                          |index|glossary|bibliography                                          |preface|reference|refentry                                          |bridgehead"/>
  </xsl:call-template>
</xsl:template>
