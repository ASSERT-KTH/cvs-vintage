 ...
 *
 */
public class GoBackAction extends AbstractColumbaAction {

	/**
	 * @param frameMediator
	 * @param name
	 */
	public GoBackAction(IFrameMediator frameMediator) {
		super(frameMediator, "Go Back");
		
		putValue(AbstractColumbaAction.TOOLBAR_NAME, "Back");
		setShowToolBarText(false);
		
		putValue(AbstractColumbaAction.SMALL_ICON, ImageLoader.getImageIcon("stock_left-16.png"));
	}
