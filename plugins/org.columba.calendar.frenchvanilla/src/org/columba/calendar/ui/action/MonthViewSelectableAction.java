 ...
 *
 */
public class MonthViewSelectableAction extends AbstractSelectableAction {

	/**
	 * @param controller
	 * @param name
	 */
	public MonthViewSelectableAction(IFrameMediator controller) {
		super(controller, "Show Month");
		
		putValue(AbstractColumbaAction.TOOLBAR_NAME, "Month");
		setShowToolBarText(true);
		
		putValue(AbstractColumbaAction.LARGE_ICON, ResourceLoader.getImageIcon("monthview.jpg"));
	}
