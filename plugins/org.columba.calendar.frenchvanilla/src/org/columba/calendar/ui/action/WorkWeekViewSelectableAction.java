 ...
 *
 */
public class WorkWeekViewSelectableAction extends AbstractSelectableAction {

	/**
	 * @param controller
	 * @param name
	 */
	public WorkWeekViewSelectableAction(IFrameMediator controller) {
		super(controller, "Show Work Week");
		
		putValue(AbstractColumbaAction.TOOLBAR_NAME, "Work Week");
		setShowToolBarText(true);
		
		putValue(AbstractColumbaAction.LARGE_ICON, ResourceLoader.getImageIcon("workweekview.jpg"));
	}
