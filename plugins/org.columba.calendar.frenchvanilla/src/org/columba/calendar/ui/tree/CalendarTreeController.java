 ...
 * 
 */
public class CalendarTreeController implements InteractionListener {
	...
	public CalendarTreeController(CalendarFrameMediator frameMediator) {
		...
		Category calendars = rootCategory.addSubCategory(
				Config.LOCAL_ROOT_NODE_ID.toString(), "Local");
		rootCategory.addSubCategory(Config.WEB_ROOT_NODE_ID.toString(), "Web");
