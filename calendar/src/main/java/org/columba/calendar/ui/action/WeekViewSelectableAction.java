 ...
 *
 */
public class WeekViewSelectableAction extends AbstractSelectableAction {

	/**
	 * @param controller
	 * @param name
	 */
	public WeekViewSelectableAction(IFrameMediator controller) {
		super(controller,"Show Week");
